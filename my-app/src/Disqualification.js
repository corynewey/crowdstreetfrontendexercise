...
class DisqualificationPage extends React.Component {
        ...
        <div>
          ...
          <div style={style}>
            <div style={formStyle}>
                ...
                <br/><br/><br/>
                Please call customer service for further help.
            </div>
          </div>
        </div>
    );
